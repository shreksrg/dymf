	...
	<div title="<?php echo $this->_var['html_title']; ?>" style="padding:20px;overflow:auto;">
      ...
      <legend>内容</legend>
		<div>
			...
			searcher="convert_search"
			prompt="请输入查询姓名..." style="width:150px">
			</input> <a href="?act=admin_convert&st=get_all" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-save'">导出所有数据</a>
		</div>
        </fieldset>
		<div style="margin-top:5px;">
			<div id="stypestate" style="">
				...
				<div class="admin_table mb10">
					<table id="convert_list_table"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<?php echo $this->smarty_insert_scripts(array('files'=>'../files/admin/js/convert/convert_list.js')); ?>
