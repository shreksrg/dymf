...
<link rel="stylesheet" href="../files/js/kindeditor/themes/default/default.css" />
<?php echo $this->smarty_insert_scripts(array('files'=>'../files/js/jquery.min.js')); ?>
		...
		<script type="text/javascript" src="../files/js/kindeditor/kindeditor.js"></script>
		<script type="text/javascript" src="../files/js/kindeditor/lang/zh_CN.js"></script><script>
var  _editOptionEz=['source', '|', 'undo', 'redo', '|'];
</script>
		<title><?php echo $this->_var['webtitle']; ?>-<?php echo $this->_var['html_title']; ?></title>
		</head>
