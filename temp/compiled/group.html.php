...
<div class='body'>
  <div class="body_back">
    <div class="banner_no1" style="text-align:right;">
      <div class="bread_path_1">首页 -> <a href="./"><?php echo $this->_var['webname']; ?></a> -> 成就之路</div>
    </div>

    <div id="g_con_body">
      <h1>加入实修小组申请</h1>
      <div class="show">* 以下内容为必填项</div>
      <form method="post" action="?act=group&st=add_group_info" id="websit_config">
      <table id="g_con_body_table" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="30%" align="right"><span>*</span> 姓名：</td>
        ...
        <tr>
          <td width="30%" align="right"><span>*</span> 您申请加入何地实修小组：</td>
          <td align="left"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="30%" align="right"><span>*</span> 学佛经历简述：</td>
          <td align="left"><textarea name="getcontent" cols="80" rows="5" id="getcontent" <?php if ($this->_var['ss_id'] != ''): ?> disabled="disabled"<?php endif; ?> ><?php echo $this->_var['info']['getcontent']; ?></textarea></td>
        </tr>
      </table>
