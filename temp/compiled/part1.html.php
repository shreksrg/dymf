		...
		<div style="background-color:#0169be">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<div class='left_top'>
						<a href="./">首页</a> > <a href="./"><?php echo $this->_var['webname']; ?></a> > <?php echo $this->_var['info']['part_name']; ?>
					</div>
					<div class="left_body">
...
?>
								<li class="part_art_li">
									<span style="float:right; color:#8c7362; margin-right:20px;"><?php echo $this->_var['value']['raw_add_time']; ?></span><a href="<?php echo $this->_var['defaultA']; ?>&id=<?php echo $this->_var['value']['article_id']; ?>"><?php echo $this->_var['value']['article_title']; ?></a>
								</li>
    ...
    foreach ($_from AS $this->_var['value']):
?>
										<li><span style="float: right; margin-right:20px;"><?php echo $this->_var['value']['raw_add_time']; ?></span>
